            ...
            <thead>
                ...
                <tbody>
                    <tr v-for="(cat,index) in categories" :key="cat.id">
                        <td>{{cat.name}}</td>
                        <td>
                            <button type="button" class="btn btn-light mr-1" @click="openEdit(cat,index)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
